...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var overlay = document.querySelector('.overlay'); // const megaMenu = document.querySelector('.mega-menu');
  ...
  menuItem.forEach(function (e) {
    var mouseOver = e.addEventListener('mouseover', displayOverlay);
    var mouseOut = e.addEventListener('mouseout', removeOverlay);
